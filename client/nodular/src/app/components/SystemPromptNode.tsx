...
import { User, GripHorizontal, X, Settings } from 'lucide-react';
...
export default function SystemNode({ data }: { data: any }) {
  ...
  const nodeClasses = `glass-pane flex flex-col shadow-2xl group z-20 rounded-xl bg-slate-850 w-96 nodrag`;
  ...
  return (
    <div className={nodeClasses}>
      ...
      <header className="drag-handle cursor-pointer flex items-center justify-between rounded-t-xl px-4 py-2 peer bg-slate-900">
      <User size={16} className="text-blue-400" />
        ...
        <div className="flex items-center gap-1">
          <button onClick={() => setShowAdvanced(!showAdvanced)} title="Advanced Settings" className="rounded p-1 text-slate-100 hover:bg-slate-700 hover:text-white">
            <Settings size={16} />
          </button>
      ...
      <div className="p-4 bg-slate-850 rounded-b-xl space-y-4">
        ...
        <div>
            <textarea
              ...
              className="w-full h-32 rounded-md border border-slate-700 bg-slate-900 p-2 text-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
        ...
        <div className="flex-1">
            ...
            <div className="thermostat-container">
              ...
              <div className="thermostat-thumb" style={{left: `calc(${temperature / 2 * 100}% - 8px)`}}></div>
            </div>
        </div>
          ...
          <div className="flex gap-4">
              ...
              <div className="flex-1">
                  ...
                  <select
                      ...
                      className="w-full rounded-md border border-slate-600 bg-slate-700 p-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500 h-[42px]"
                  >
